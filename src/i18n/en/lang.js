...
export default {
    ...
    __lennonwallOnGoing: 'Current Development: Investigate in IPFS node for the site to keep the file.',
    ...
    __newFileHeadline : 'Upload file to InterPlanetary File System. Once the file being uploaded, it can\'t be actively modify or delete by uploader. (Please keep a backup copy of the file)',
    ...
    __newFileHeadProcedure: '<b>Once the message being submitted and confirmed, it can\'t be modify or delete. </b> The file will be kept and pinned on Infura IPFS node and to be accessed anytime. Not 100% guarantee the file will be kept forever as the node might be offline. Please always keep a backup copy of the file. We are using free service of ipfs.infura.io, it depends on infura to decide if they are going to keep the file. In long run we need to setup our IPFS node to ensure file existence.',
